...
class PasswordConfirmationFormField extends StatefulWidget {
  ...
  final String title;
  final double width;
  final GlobalKey<PasswordFormFieldState> toConfirmKey;

  @override
  State<PasswordConfirmationFormField> createState() =>
      _PasswordConfirmationFormFieldState();
}

class _PasswordConfirmationFormFieldState
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                return AppLocalizations.of(context)!.errorPasswordEmpty;
                      ...
                      .toConfirmKey.currentState!.passwordController.text !=
                  _passController.text) {
                return AppLocalizations.of(context)!.errorPasswordDifferent;
              }
              return null;
            },
